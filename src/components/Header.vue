<template>
    <header class="bg-white w-full flex flex-wrap justify-center items-center content-center border-b border-gray-300 mt-4 lg:mt-0 px-4 lg:px-0">
      ...
      <div class="z-50 md:px-6 w-full flex lg:flex-wrap flex-wrap-reverse justify-center content-center items-center">
        <!-- <div class="text-lg font-medium flex flex-wrap justify-center content-center items-center inline-block"> -->
          <g-link to="/" title="Back to Home" class="hidden lg:flex text-gray-700 no-underline cursor-pointer flex-wrap justify-center content-center items-center">
        ...
        <nav class="text-xl font-medium flex flex-wrap justify-center content-center items-center">
          ...
          <g-link title="Twitter" href="https://twitter.com/4unaturalistic" target="_blank" class="cursor-pointer hidden md:inline-block mr-4 focus:outline-none text-gray-800 hover:text-teal-400 focus:text-teal-400 justify-center items-center transition-all duration-300">
          ...
          <g-link title="Youtube" href="https://www.youtube.com/channel/UCSD22hYdpUh7DK24cQKLBLQ" target="_blank" class="cursor-pointer hidden md:inline-block mr-4 focus:outline-none text-gray-800 hover:text-teal-400 focus:text-teal-400 justify-center items-center transition-all duration-300">
          ...
          <g-link title="Facebook" href="https://www.facebook.com/4unaturalistic/" target="_blank" class="cursor-pointer hidden md:inline-block mr-4 focus:outline-none text-gray-800 hover:text-teal-400 focus:text-teal-400 justify-center items-center transition-all duration-300">
          ...
          <g-link title="Instagram" href="https://www.instagram.com/4unaturalistic/" target="_blank" class="cursor-pointer hidden md:inline-block mr-4 focus:outline-none text-gray-800 hover:text-teal-400 focus:text-teal-400 justify-center items-center transition-all duration-300">
