      ...
      <div class="z-50 px-0 md:px-8 lg:px-10 w-full flex md:flex-wrap flex-wrap-reverse justify-center md:justify-between content-center items-center">
        ...
        <nav class="text-xl font-medium flex flex-wrap justify-center content-center items-center">
            ...
            <g-link title="Facebook" href="https://www.facebook.com/4unaturalistic/" target="_blank" class="cursor-pointer hidden md:inline-block mr-4 focus:outline-none text-gray-800 hover:text-teal-500 focus:text-teal-500 flex justify-center items-center">
                <svg class="w-6 h-6 inline-block fill-current" viewBox="0 0 444 448"><path d="M221.746 0c-208.1 0-301.5 246-139.4 368.6V448l75.7-42c142.2 39.8 285.4-59.9 285.4-198.7.1-114.5-99.2-207.3-221.7-207.3zm23.4 278.1l-57.4-59.6-110.4 61.1 121.1-128.5 57.4 59.6 110.4-61.1-121.1 128.5z"/></svg>
            </g-link>
