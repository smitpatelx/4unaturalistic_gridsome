            ...
            <ais-search-box>
                <div slot-scope="{ currentRefinement, isSearchStalled, refine }">
                    <label class="mr-6 relative justify-center items-center content-center leading-none flex w-full pr-4">
                        ...
                        class="self-stretch py-2 text-base bg-transparent focus:outline-none bg-gray-200 focus:bg-white text-gray-700 rounded pl-5 pr-10 border-2 border-transparent focus:border-teal-500 w-full block"/>
