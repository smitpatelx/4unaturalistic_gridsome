    ...
    <Layout>
        <div class="relative">
            <div class="px-6 md:px-16 lg:px-24 flex flex-wrap fonts-primary mx-auto container bg-white w-full">
                ...
                <div class="z-50 fixed bottom-0 left-0 mb-2 ml-2 p-1 bg-white rounded-full ring-teal-400 ring flex flex-wrap flex-row justify-center items-center content-center">
                    <div class="bg-white rounded-full px-4 py-1 flex flex-wrap">
                        <a title="Share on Twitter" :href="'https://twitter.com/intent/tweet?url='+currenturl" target="_blank" class="cursor-pointer inline-block mr-3 focus:outline-none text-teal-500 hover:text-teal-700 focus:text-teal-700 flex justify-center items-center">
                        ...
                        <a title="Share on Facebook" :href="'https://www.facebook.com/sharer/sharer.php?u='+currenturl" target="_blank" class="cursor-pointer inline-block mr-3 focus:outline-none text-teal-500 hover:text-teal-700 focus:text-teal-700 flex justify-center items-center">
                ...
                <div class="w-full flex flex-wrap justify-center items-center font-normal text-base text-gray-700 self-auto my-4">
                    ...
                    <g-image :src="$page.contentfulPosts.author.authorImage.file.url" alt="author-avatar" class="bg-white shadow-md rounded-full h-12 w-12 mx-3"/>
                    <span class="mr-2 font-semibold text-lg text-gray-700" >{{$page.contentfulPosts.author.firstName}} {{$page.contentfulPosts.author.lastName}}</span>
                </div>
                <g-image class="rounded-lg my-6 shadow-lg object-cover w-full" style="max-height: 18rem;" quality="30" :src="$page.contentfulPosts.postCover.file.url" :alt="$page.contentfulPosts.postCover.file.fileName"/>
                <div class="wp-content py-10 w-full" v-html="richTextToHTML($page.contentfulPosts.postContent)"></div>
        ...
        <client-only>
            <div class="flex flex-wrap justify-center items-center w-full container mx-auto pb-16 px-8 md:px-0">
                <vue-disqus class="w-full" :title="$page.contentfulPosts.postSlug"  shortname="https-4unaturalistic-netlify-com" :identifier="$page.contentfulPosts.id"></vue-disqus>
            </div>
        </client-only>
    </Layout>
</template>
