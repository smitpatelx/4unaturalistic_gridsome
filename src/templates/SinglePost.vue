            ...
            <div class="px-6 md:px-16 lg:px-24 flex flex-wrap fonts-primary mx-auto container bg-white w-full">
                ...
                <div class="z-50 fixed bottom-0 left-0 mb-2 ml-2 px-1 py-1 bg-white rounded-full bg-teal-600 flex flex-wrap flex-row justify-center items-center">
                    <div class="bg-white rounded-full px-4 py-1 inline-block">
                        <a title="Share on Twitter" :href="'https://twitter.com/intent/tweet?url='+currenturl" target="_blank" class="cursor-pointer hidden md:inline-block mr-3 focus:outline-none text-teal-500 hover:text-teal-700 focus:text-teal-700 flex justify-center items-center">
