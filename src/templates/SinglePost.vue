    ...
    <Layout>
        ...
        <div class="relative">
            <div class="px-6 md:px-16 lg:px-24 flex flex-wrap fonts-primary mx-auto container bg-white w-full">
                ...
                <div class="z-50 fixed bottom-0 left-0 mb-2 ml-2 p-1 bg-white rounded-full bg-teal-600 flex flex-wrap flex-row justify-center items-center content-center">
                    <div class="bg-white rounded-full px-4 py-1 flex flex-wrap">
                        ...
                        <a title="Share on Facebook" :href="'https://www.facebook.com/sharer/sharer.php?u='+currenturl" target="_blank" class="cursor-pointer inline-block mr-3 focus:outline-none text-teal-500 hover:text-teal-700 focus:text-teal-700 flex justify-center items-center">
                            <svg class="w-4 h-4 md:w-5 md:h-5 inline-block fill-current" viewBox="0 0 444 448"><path d="M221.746 0c-208.1 0-301.5 246-139.4 368.6V448l75.7-42c142.2 39.8 285.4-59.9 285.4-198.7.1-114.5-99.2-207.3-221.7-207.3zm23.4 278.1l-57.4-59.6-110.4 61.1 121.1-128.5 57.4 59.6 110.4-61.1-121.1 128.5z"/></svg>
                        </a>
                    ...
                    <p class="text-white font-semibold text-lg mx-2 hidden md:inline-block">Share</p>
                </div>
